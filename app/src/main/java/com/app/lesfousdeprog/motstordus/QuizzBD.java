    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        suivant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //si le quiz est terminé affecte le texte "Fin du Quiz" au bouton suivant
...
private void updateQuestion(){
    ...
    if (nQuestionNumber==10) {
        ...
        nQuestionView.setText(nQuizz.getQuestionsbd(nQuestionNumber));//affecte le texte de la question correspondant au numéro de question
